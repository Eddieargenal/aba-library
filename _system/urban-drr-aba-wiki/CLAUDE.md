...
- Create or update the source page in wiki/01-sources/
- Update affected concept pages in wiki/02-concepts/
- Update affected tool pages in wiki/04-tools/
- Update lifecycle pages in wiki/06-lifecycle/
- Update field instruments in wiki/05-field-instruments/ if the source implies data collection methods
- Update wiki/12-risks-contradictions/ if claims conflict or require caution
- Update index.md
- Append to log.md
