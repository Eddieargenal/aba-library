...
### Ingest new sources
Use the prompt at [[wiki/13-agent-prompts/ingest-new-source.md]]. Follow ingest-rules.md.

### Generate tools from sources
Use the prompt at [[wiki/13-agent-prompts/build-new-tool-from-sources.md]].

### Generate field instruments
Use the prompt at [[wiki/13-agent-prompts/generate-field-instrument.md]].

### Create decision memos
Use the template at [[wiki/13-agent-prompts/create-decision-memo.md]].

### Lint the wiki
Use the prompt at [[wiki/13-agent-prompts/lint-wiki.md]]. Check against [[schema/lint-rules.md]].
