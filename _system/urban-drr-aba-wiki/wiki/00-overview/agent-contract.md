...
## Rule precedence
1. `wiki/00-overview/agent-contract.md` (this page)
2. `CLAUDE.md` and `schema/*.md`
3. `wiki/13-agent-prompts/*.md`
...
4. Use `wiki/01-sources/` pages for citation metadata and traceability.
...
- Run `wiki/13-agent-prompts/run-manual-lint-checklist.md` when automation is unavailable.
