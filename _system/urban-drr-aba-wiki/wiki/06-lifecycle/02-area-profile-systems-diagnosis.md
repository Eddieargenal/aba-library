...
# Stage 2: Area Profile and Systems Diagnosis

## Stage purpose
Build a comprehensive profile of the selected area covering urban systems status, stakeholder landscape, HEVC risk, service functionality, and local resources. This stage produces the evidence base for area strategy design.

## Key decisions
TODO[agent]: Define 3-5 key decisions that must be made at this stage. Key sources: 2017-irc-urban-context-analysis-toolkit-guidance-note, 2016-campbell-stepping-back-understanding-cities-systems-guide.
...
## Links
- Related framework: [[wiki/03-frameworks/neighborhood-diagnosis-framework]]
