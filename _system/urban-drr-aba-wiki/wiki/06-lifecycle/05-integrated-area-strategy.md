...
# Stage 5: Integrated Area Strategy

## Stage purpose
Design a coherent integrated strategy for the area combining sector interventions, DRR actions, local actor roles, and coordination mechanisms into a unified program framework grounded in area evidence.

## Key decisions
TODO[agent]: Define 3-5 key decisions that must be made at this stage. Key sources: 2017-mohiddin-smith-phelps-urban-response-analysis-framework, 2017-sanderson-sitko-urban-area-based-approaches-post-disaster-guide.

## Required evidence
TODO[agent]: Define minimum evidence required before this stage can be completed.

## Tools to use
- [[wiki/04-tools/10-integrated-area-strategy-tool]]
...
## Links
- Related framework: [[wiki/03-frameworks/integrated-area-strategy-framework]]
