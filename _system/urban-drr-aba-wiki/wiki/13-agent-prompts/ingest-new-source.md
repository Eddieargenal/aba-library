...
5. Create source page in wiki/01-sources/ using frontmatter-schema.md
...
11. Check for contradictions with existing sources → update wiki/12-risks-contradictions/known-contradictions.md
12. Update index.md
