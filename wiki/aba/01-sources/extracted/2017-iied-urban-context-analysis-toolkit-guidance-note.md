...
sections:
  - id: summary
    anchor: "#summary"
    purpose: Source-level summary and scope
  - id: key-concepts
    anchor: "#key-concepts"
    purpose: Conceptual objects (frameworks, typologies, concepts, principles)
  - id: methods-and-tools
    anchor: "#methods-and-tools"
    purpose: Methods and toolkit instruments
  - id: lifecycle-coverage
    anchor: "#lifecycle-coverage"
    purpose: Lifecycle stage mapping
  - id: known-tensions
    anchor: "#known-tensions"
    purpose: Internal tensions and contradictions
  - id: decision-logic
    anchor: "#decision-logic"
    purpose: Decision rules and conditional guidance
  - id: findings
    anchor: "#findings"
    purpose: Compact routing records (one per object)
  - id: task-seeds
    anchor: "#task-seeds"
    purpose: Future wiki work items
  - id: integration-map
    anchor: "#integration-map"
    purpose: Derived routing lookup table
institutional_credibility: high
evidence_quality: medium
composite_authority: mixed
comparison_readiness: medium
primary_context: urban
urban_applicability: direct
urban_adaptation_scope: none
urban_adaptation_notes: "Document designed specifically for urban displacement contexts; no rural adaptation required; directly applicable to urban ABA/DRR programming"
knowledge_layer: operational
cited_sources:
  - slug: parker-maynard-2015
    title: "Humanitarian response to urban crises: a review of area-based approaches"
    cited_for: "Definition of sub-area as geographically-bounded community unit; ABA cross-reference"
  - slug: campbell-alnap-2016
    title: "Stepping back: understanding cities and their systems"
    cited_for: "Source of urban systems typology (Figure 3) used in thematic framework"
  - slug: meaux-osofisan-2016
    title: "A Review of Context Analysis Tools for Urban Humanitarian Response"
    cited_for: "Research basis for thematic framework and sub-theme structure"
  - slug: basedow-et-al-2017
    title: "Urban stakeholder engagement and coordination"
    cited_for: "Further guidance on key stakeholders for urban areas"
  - slug: sanderson-knox-clarke-campbell-2012
    title: "Responding to Urban Disasters: Learning from previous relief and recovery operations"
    cited_for: "Urban disaster response lessons reference"

findings:
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-FRAMEWORK-001
    type: FRAMEWORK
    label: "Urban Context Analysis Thematic Framework"
    layer: conceptual
    source_pages: "pp. 16–19, Step 3, Table 3, Figure 3"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/03-frameworks/urban-context-analysis-framework.md"]
    integration_action: create-framework
    routing_rationale: "No existing urban context analysis framework page; primary analytical framework warrants its own page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TYPOLOGY-001
    type: TYPOLOGY
    label: "Urban Displacement Crisis Typology"
    layer: conceptual
    source_pages: "p. 15, Table 2"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/urban-displacement-crisis-typology.md"]
    integration_action: create-concept
    routing_rationale: "Standalone typology not present in wiki; distinct from DRR risk typologies."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-001
    type: CONCEPT
    label: "Urban Context Analysis"
    layer: conceptual
    source_pages: "pp. 7–9, 34"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/urban-context-analysis.md"]
    integration_action: create-concept
    routing_rationale: "Core concept of source; no existing wiki page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-002
    type: CONCEPT
    label: "Sub-Area as Unit of Analysis"
    layer: conceptual
    source_pages: "pp. 15–16, Step 2"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/sub-area-unit-of-analysis.md"]
    integration_action: create-concept
    routing_rationale: "Extends Parker & Maynard 2015 with operational specificity; foundational for ABA geographic targeting."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-003
    type: CONCEPT
    label: "Context Analysis vs Needs Assessment Distinction"
    layer: conceptual
    source_pages: "pp. 8–9"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/context-analysis-vs-needs-assessment.md"]
    integration_action: create-concept
    routing_rationale: "Explicitly stated conceptual boundary; prevents misuse of toolkit as needs assessment substitute."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-004
    type: CONCEPT
    label: "Entry Point Identification"
    layer: conceptual
    source_pages: "pp. 8–9, 34"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/entry-point-identification.md"]
    integration_action: create-concept
    routing_rationale: "Terminal output purpose of context analysis; most explicit operational definition for urban humanitarian response."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-PRINCIPLE-001
    type: PRINCIPLE
    label: "Do No Harm"
    layer: conceptual
    source_pages: "pp. 17–18, Step 3"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/do-no-harm-principle.md"]
    integration_action: create-concept
    routing_rationale: "Cross-cutting principle referenced throughout source; foundational for risk and safeguard routing."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-PRINCIPLE-002
    type: PRINCIPLE
    label: "Gender Equality Analytical Lens"
    layer: conceptual
    source_pages: "pp. 17–18, Step 3"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/gender-equality-analytical-lens.md"]
    integration_action: create-concept
    routing_rationale: "Methodological principle for analysis conduct; distinct from gender equality as programme objective."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-001
    type: METHOD
    label: "Urban Context Analysis Process"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/urban-context-analysis-process.md"]
    integration_action: create-tool
    routing_rationale: "Primary method; 10-step structured workflow merits its own tool page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-002
    type: METHOD
    label: "Desk Review Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/desk-review-method-urban-context-analysis.md"]
    integration_action: create-tool
    routing_rationale: "Standard desk review adapted for urban CA; sequencing dependency (RULE-007) makes it a standalone entry."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-003
    type: METHOD
    label: "Key Informant Interview (KII) Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/key-informant-interview-method.md"]
    integration_action: create-tool
    routing_rationale: "Named method with specific urban adaptation guidance; merits own tool page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-004
    type: METHOD
    label: "Focus Group Discussion (FGD) Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/focus-group-discussion-method-urban.md"]
    integration_action: create-tool
    routing_rationale: "FGD method with gender-separation rule and protection protocol specific to urban displacement."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-005
    type: METHOD
    label: "Stakeholder Analysis / Actor Mapping Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/stakeholder-analysis-actor-mapping.md"]
    integration_action: create-tool
    routing_rationale: "Cross-phase method; difficult-stakeholder emphasis is urban-specific."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-006
    type: METHOD
    label: "Participatory Validation Workshop Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/participatory-validation-workshop-method.md"]
    integration_action: create-tool
    routing_rationale: "Distinct from data collection workshops; gender considerations (RULE-011); linked to TOOL-009."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-007
    type: METHOD
    label: "Systems-Thinking Analytical Approach"
    layer: diagnostic
    ...
    routing_rationale: "Analytical logic behind FRAMEWORK-001; route as enrichment to framework page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-008
    type: METHOD
    label: "Snowball/Referral Sampling Method"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/snowball-referral-sampling-method.md"]
    integration_action: create-tool
    routing_rationale: "Addresses RISK-001; recommended to counter gatekeeper dependence in urban displacement."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-001
    type: TOOL
    label: "Tool 1 — Workplan and Budget Template"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-1-workplan.md"]
    integration_action: create-tool
    routing_rationale: "Standalone planning instrument; 14-day calibrated template for urban CA."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-002
    type: TOOL
    label: "Tool 2 — Desk Review Summary Template"
    layer: diagnostic
    source_pages: "pp. 20–21, Step 4"
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-2-desk-review-summary.md"]
    integration_action: create-tool
    routing_rationale: "Desk review instrument aligned to FRAMEWORK-001 sub-themes; operationalises METHOD-002 and RULE-007."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-003
    type: TOOL
    label: "Tool 3 — Stakeholder Analysis Matrix"
    layer: diagnostic
    source_pages: "pp. 22–23, pp. 29–31"
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-3-stakeholder-matrix.md"]
    integration_action: create-tool
    routing_rationale: "Instrument operationalising METHOD-005; cross-phase use; includes difficult-stakeholder column."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-004
    type: TOOL
    label: "Tool 4 — Data Collection Plan Template"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-4-data-collection-plan.md"]
    integration_action: create-tool
    routing_rationale: "Two-tab structure separating sub-area from city-wide sampling."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-005
    type: TOOL
    label: "Tools 5A–5G — KII and FGD Question Guide Set"
    layer: diagnostic
    source_pages: "pp. 24–26, Step 5"
    ...
    candidate_target_pages: ["wiki/aba/05-field-instruments/iied-2017-urban-context-analysis-kii-fgd-guides.md"]
    integration_action: create-field-instrument
    routing_rationale: "Seven-instrument set; routes to 05-field-instruments/; template content externally hosted."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-006
    type: TOOL
    label: "Tool 6 — KII and FGD Debrief Template"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-6-debrief-template.md"]
    integration_action: create-tool
    routing_rationale: "Operationalises IMPL-005; bridge between data collection and analysis phases."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-007
    type: TOOL
    label: "Tool 7 — Key Findings Analysis Template"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-7-key-findings.md"]
    integration_action: create-tool
    routing_rationale: "Primary analysis instrument; multi-column cross-area comparison structure is distinctive."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-008
    type: TOOL
    label: "Tool 8 — Programme Implications Template"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-8-programme-implications.md"]
    integration_action: create-tool
    routing_rationale: "Terminal output instrument; operationalises CONCEPT-004; critical bridge to programme design."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-009
    type: TOOL
    label: "Tool 9 — Urban Analysis Validation Workshop"
    layer: diagnostic
    source_pages: "pp. 31–32, Step 8"
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-9-validation-workshop.md"]
    integration_action: create-tool
    routing_rationale: "Operationalises METHOD-006; includes RULE-011 trigger (women-only working groups)."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-010
    type: TOOL
    label: "Tool 10 — Urban Context Analysis Final Report Outline"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-10-final-report-outline.md"]
    integration_action: create-tool
    routing_rationale: "Terminal documentation instrument; operationalises RULE-012 and IMPL-006."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-001
    type: RULE
    label: "Separate FGDs by Gender/Age Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/fgd-gender-age-separation-protocol.md"]
    integration_action: create-decision-rule
    routing_rationale: "Stated planning requirement for FGD design; applies to all contexts using METHOD-004."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-002
    type: RULE
    label: "Context Analysis Reassessment Trigger Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/context-analysis-reassessment-trigger.md"]
    integration_action: create-decision-rule
    routing_rationale: "Four-trigger decision rule for high-stakes operational decision; 6-9 month threshold is practitioner heuristic."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-003
    type: RULE
    label: "Partner Inclusion Restriction Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/partner-inclusion-in-context-analysis.md"]
    integration_action: create-decision-rule
    routing_rationale: "Conditional rule; requires human judgment on context-specific risk levels — significant conflict not defined with criteria."
    human_review_required: true
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-004
    type: RULE
    label: "Do No Harm Data Collection Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/do-no-harm-data-collection-checklist.md"]
    integration_action: create-decision-rule
    routing_rationale: "Operationalises PRINCIPLE-001 at data collection stage."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-005
    type: RULE
    label: "Participant Data Protection Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/participant-data-protection-protocol.md"]
    integration_action: create-decision-rule
    routing_rationale: "Operationalises SAFE-001 as decision rule; connected to RISK-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-006
    type: RULE
    label: "Triangulation Requirement Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/qualitative-triangulation-requirement.md"]
    integration_action: create-decision-rule
    routing_rationale: "Essential analytical quality control; addresses single-perspective bias risk."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-007
    type: RULE
    label: "Desk Review Before Fieldwork Rule"
    layer: decision
    source_pages: "pp. 20–21, Step 4"
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/desk-review-sequencing-rule.md"]
    integration_action: create-decision-rule
    routing_rationale: "Sequencing dependency in METHOD-001; violating it undermines data collection quality."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-008
    type: RULE
    label: "Question Guide Adaptation Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/question-guide-adaptation-protocol.md"]
    integration_action: create-decision-rule
    routing_rationale: "Mandatory requirement applying to all seven Tools 5A-5G; operationalises IMPL-007."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-009
    type: RULE
    label: "Gender-Only Analysis Toolkit Selection Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/assessment-tool-selection-gender-only.md"]
    integration_action: create-decision-rule
    routing_rationale: "Toolkit scoping rule; prevents misapplication when gender analysis is sole interest."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-010
    type: RULE
    label: "Participatory Planning Workshop Trigger Rule"
    layer: decision
    source_pages: "p. 25"
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/participatory-planning-workshop-trigger.md"]
    integration_action: create-decision-rule
    routing_rationale: "Conditional trigger for optional preparatory step; distinct from validation workshop."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-011
    type: RULE
    label: "Women-Only Validation Workshop Groups Rule"
    layer: decision
    ...
    routing_rationale: "Extends RULE-001 to validation workshop phase; enrichment to same gender-separation protocol."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-012
    type: RULE
    label: "Sensitive Findings Internal-Only Report Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/context-analysis-report-sensitivity-protocol.md"]
    integration_action: create-decision-rule
    routing_rationale: "Operationalises RULE-005 at report stage; LESSON-003 illustrates dual-document solution."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-013
    type: RULE
    label: "Culturally-Matched Team Composition Rule"
    layer: decision
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/team-composition-cultural-matching-rule.md"]
    integration_action: create-decision-rule
    routing_rationale: "Stated as essential; Dar es Salaam case provides evidence base; addresses RISK-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-001
    type: IMPL
    label: "Team Composition and Roles"
    layer: operational
    ...
    routing_rationale: "Implementation detail; enriches METHOD-001 tool page; connected to RULE-013 and SAFE-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-002
    type: IMPL
    label: "Sub-Area Selection and Prioritization"
    layer: operational
    source_pages: "pp. 15–16, Step 2"
    ...
    routing_rationale: "Provides operational criteria for sub-area selection; enriches CONCEPT-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-003
    type: IMPL
    label: "Joint and Partner Analysis Design"
    layer: operational
    source_pages: "p. 14, 'Joint analysis and partnerships'"
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/partner-inclusion-in-context-analysis.md"]
    integration_action: enrich-decision-rule
    routing_rationale: "Implementation logic for partner inclusion; enriches RULE-003 decision protocol."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-004
    type: IMPL
    label: "Data Collection Team Training and Orientation"
    layer: operational
    source_pages: "pp. 25–26"
    ...
    candidate_target_pages: ["wiki/aba/04-tools/urban-context-analysis-process.md"]
    integration_action: enrich-tool
    routing_rationale: "Training protocol within METHOD-001; enriches process tool page."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-005
    type: IMPL
    label: "Daily Debrief and Mid-Collection Review"
    layer: operational
    source_pages: "pp. 27–28, Step 6"
    ...
    candidate_target_pages: ["wiki/aba/04-tools/iied-2017-urban-context-analysis-tool-6-debrief-template.md"]
    integration_action: enrich-tool
    routing_rationale: "Operationalises TOOL-006; documents procedural logic for debrief tool mid-fieldwork."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-006
    type: IMPL
    label: "Findings Communication and Dissemination"
    layer: operational
    ...
    candidate_target_pages: ["wiki/aba/04-tools/urban-context-analysis-process.md"]
    integration_action: enrich-tool
    routing_rationale: "Implementation logic for Step 10; references RULE-012, LESSON-003, and RULE-005."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-IMPL-007
    type: IMPL
    label: "Question Guide Adaptation and Contextualization"
    layer: operational
    source_pages: "pp. 25–26"
    ...
    routing_rationale: "Procedural logic for adapting Tools 5A-5G; operationalises RULE-008."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RISK-001
    type: RISK
    label: "Sampling Bias from Key Powerholder Dependence"
    layer: diagnostic
    source_pages: "p. 27, Step 6"
    ...
    candidate_target_pages: ["wiki/aba/06-risks/sampling-bias-powerholder-dependence.md"]
    integration_action: create-risk
    routing_rationale: "Structural risk in urban humanitarian data collection; mitigated by METHOD-008, RULE-006, SAFE-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RISK-002
    type: RISK
    label: "Protection Risk from Data Collection Exposure"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/06-risks/data-collection-exposure-risk-displaced-populations.md"]
    integration_action: create-risk
    routing_rationale: "Urban-specific risk with direct evidence from Dar es Salaam pilot; high consequence if unmitigated."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RISK-003
    type: RISK
    label: "Partner Bias in Joint Context Analysis"
    layer: diagnostic
    ...
    candidate_target_pages: ["wiki/aba/06-risks/partner-bias-joint-analysis-risk.md"]
    integration_action: create-risk
    routing_rationale: "Named risk in source; addressed by RULE-003 and IMPL-003."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-RISK-004
    type: RISK
    label: "Context Analysis Staleness Risk"
    layer: diagnostic
    source_pages: "p. 33"
    ...
    candidate_target_pages: ["wiki/aba/06-risks/context-analysis-staleness-risk.md"]
    integration_action: create-risk
    routing_rationale: "Mitigated by RULE-002; 6-9 month threshold is practitioner heuristic."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-LESSON-001
    type: LESSON
    label: "Dar es Salaam Sub-Area Selection Lesson"
    layer: operational
    source_pages: "p. 16"
    ...
    candidate_target_pages: ["wiki/aba/02-concepts/sub-area-unit-of-analysis.md"]
    integration_action: enrich-concept
    routing_rationale: "Substantiates IMPL-002 and CONCEPT-002; enrich sub-area concept page with field evidence."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-LESSON-002
    type: LESSON
    label: "Dar es Salaam Identity Masking Lesson"
    layer: operational
    source_pages: "p. 28"
    ...
    routing_rationale: "Provides direct field evidence for RISK-002; demonstrates SAFE-002 and RULE-013 are operationally necessary."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-LESSON-003
    type: LESSON
    label: "Maiduguri Dual-Document Lesson"
    layer: operational
    source_pages: "p. 33"
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/context-analysis-report-sensitivity-protocol.md"]
    integration_action: enrich-decision-rule
    routing_rationale: "Operationalises RULE-012; demonstrates dual-document solution as concrete practice model."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-ASM-001
    type: ASM
    label: "Country Presence Assumption"
    layer: conceptual
    source_pages: "pp. 9, 12"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/urban-context-analysis.md"]
    integration_action: enrich-concept
    routing_rationale: "Scope limitation; enriches CONCEPT-001 with applicability boundaries."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-ASM-002
    type: ASM
    label: "Representative Sampling Assumption"
    layer: conceptual
    source_pages: "pp. 25–27"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/06-risks/sampling-bias-powerholder-dependence.md"]
    integration_action: enrich-risk
    routing_rationale: "Creates TNS-001 tension with RISK-001; enriches sampling bias risk page with internal tension flag."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-ASM-003
    type: ASM
    label: "Optional Final Report Assumption"
    layer: conceptual
    source_pages: "p. 32, Step 9"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/urban-context-analysis.md"]
    integration_action: enrich-concept
    routing_rationale: "Creates ambiguity about completion; advisory work should flag institutional knowledge risk."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SAFE-001
    type: SAFE
    label: "Data Collection Protection Protocol"
    layer: operational
    source_pages: "p. 28"
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/participant-data-protection-protocol.md"]
    integration_action: enrich-decision-rule
    routing_rationale: "Operationalises RULE-005; provides procedural safeguard specification."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SAFE-002
    type: SAFE
    label: "Culturally-Matched Team Composition Safeguard"
    layer: operational
    ...
    candidate_target_pages: ["wiki/aba/09-decision-protocols/team-composition-cultural-matching-rule.md"]
    integration_action: enrich-decision-rule
    routing_rationale: "Safeguard version of RULE-013; enriches cultural-matching protocol with Dar es Salaam evidence."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-TNS-001
    type: TNS
    label: "Sampling Representativeness Tension"
    layer: conceptual
    source_pages: "pp. 25–27"
    field_query_trigger: not-applicable
  ...
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-001
    type: SEED
    label: "Urban Context Analysis Pre-Programme Design Task"
    layer: operational
    source_pages: "pp. 7–11, 34"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/urban-context-analysis.md", "wiki/aba/04-tools/urban-context-analysis-process.md"]
    integration_action: create-concept
    routing_rationale: "High-priority seed; full coverage; actionable with existing objects."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-002
    type: SEED
    label: "Context Analysis for Area-Based Programme Design Task"
    layer: operational
    source_pages: "pp. 8–9, 15–16"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/sub-area-unit-of-analysis.md", "wiki/aba/02-concepts/entry-point-identification.md"]
    integration_action: create-concept
    routing_rationale: "High-priority seed; partial coverage; requires cross-source synthesis."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-003
    type: SEED
    label: "Context Analysis Update Decision Protocol Task"
    layer: decision
    source_pages: "p. 33"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/09-decision-protocols/context-analysis-reassessment-trigger.md"]
    integration_action: create-decision-rule
    routing_rationale: "High-priority seed; served by RULE-002 and RISK-004."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-004
    type: SEED
    label: "Urban Context Analysis Toolkit Inventory Task"
    layer: diagnostic
    source_pages: "pp. 10–11, 34"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/04-tools/urban-context-analysis-process.md"]
    integration_action: create-tool
    routing_rationale: "High-priority seed; all 10 tools have individual target pages."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-005
    type: SEED
    label: "Partner Inclusion Decision Task"
    layer: decision
    source_pages: "p. 14"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/09-decision-protocols/partner-inclusion-in-context-analysis.md"]
    integration_action: create-decision-rule
    routing_rationale: "Medium-priority seed; served by RULE-003, RULE-010, RISK-003, IMPL-003."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-006
    type: SEED
    label: "Urban Data Collection Risks and Mitigations Task"
    layer: operational
    source_pages: "pp. 26–28"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/06-risks/sampling-bias-powerholder-dependence.md", "wiki/aba/06-risks/data-collection-exposure-risk-displaced-populations.md"]
    integration_action: create-risk
    routing_rationale: "Medium-priority seed; partial coverage; served by RISK-001, RISK-002, SAFE-001, SAFE-002."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-007
    type: SEED
    label: "Sub-Area Definition and Selection Task"
    layer: operational
    source_pages: "pp. 15–16"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/sub-area-unit-of-analysis.md"]
    integration_action: create-concept
    routing_rationale: "High-priority seed connecting CONCEPT-002, IMPL-002, LESSON-001."
    human_review_required: false
  - id: S-2017-iied-urban-context-analysis-toolkit-guidance-note-SEED-008
    type: SEED
    label: "Context Analysis vs Needs Assessment Relationship Task"
    layer: conceptual
    source_pages: "pp. 8–9"
    field_query_trigger: not-applicable
    candidate_target_pages: ["wiki/aba/02-concepts/context-analysis-vs-needs-assessment.md", "wiki/aba/07-known-tensions/context-analysis-vs-needs-assessment-tension.md"]
    integration_action: create-concept
    routing_rationale: "Routes to CONCEPT-003 page and a known tension page."
    human_review_required: false
---
...
This guidance note introduces a practical urban context analysis toolkit for humanitarian practitioners working in urban crises, especially displacement settings. Developed by the International Rescue Committee (IRC) Stronger Cities Initiative and published by IIED under the Urban Crises Learning Fund (funded by DFID), the toolkit was piloted in five urban crisis contexts: Maiduguri (Nigeria), Juba (South Sudan), Amman (Jordan), Dar es Salaam (Tanzania), and Bangkok (Thailand).

The toolkit provides a user-friendly, relatively quick, and adaptable mechanism for understanding complex urban dynamics before programme design and implementation. It is structured as a 3-phase, 10-step process supported by 10 practical instruments (workplan, desk review summary, stakeholder analysis matrix, data collection plan, 7 KII/FGD question guides, debrief template, key findings analysis, programme implications template, validation workshop tool, and final report outline). The toolkit enables users to identify relevant stakeholders, existing power relations, resource distribution, governance and legal frameworks, sources of livelihoods, social networks, and access to services — information that helps determine suitable entry points and improve the effectiveness and responsiveness of humanitarian programmes.

A critical scope boundary is explicitly stated: context analysis is not a substitute for needs or vulnerability assessments. Context analysis answers "why" questions (structural and systemic factors shaping crisis dynamics), while needs assessment answers "what" questions (visible effects and service gaps). Both are required. The document also notes the toolkit is primarily designed for organisations already established in-country; teams needing rapid response context analysis are directed to alternative tools (GECARR, IRC conflict sensitivity toolkit).

The analysis is organized around five interconnected thematic areas — politics and governance, social and cultural, economic, service delivery and infrastructure, and space and settlements — with Do No Harm and gender equality as mandatory cross-cutting lenses. A systems-thinking approach examines interconnections between thematic areas rather than analysing each in isolation. The toolkit has been tested and refined through field implementation, though the evidence base remains practitioner-generated rather than peer-reviewed, giving it mixed composite authority.
...
| Lifecycle Stage | Relevant Objects | Notes |
|---|---|---|
| Appropriateness decision | FRAMEWORK-001, TYPOLOGY-001, CONCEPT-001, CONCEPT-003, METHOD-001, RULE-002 | Context analysis is a pre-programming tool; toolkit determines whether and where to engage |
| Neighbourhood diagnosis | CONCEPT-002, METHOD-002–008, TOOL-001–010, IMPL-001–005, RULE-001, RULE-004–008 | Core of the toolkit — 3-phase process from desk review through primary data collection |
| Response design | CONCEPT-004, METHOD-005–006, TOOL-007–010, IMPL-006–007, RULE-003, RULE-010–012 | Analysis outputs feed directly into programme design, partnership selection, and risk mitigation |
...
### Urban Context Analysis Thematic Framework
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-FRAMEWORK-001`** | knowledge_layer: conceptual

A systems-thinking framework organising urban context analysis around five interconnected thematic areas: (1) politics and governance (stakeholder power, governance structure, policy/legal frameworks); (2) social and cultural (social cohesion, identities, protection risks); (3) economic (labour market, livelihoods, constraints); (4) service delivery and infrastructure (access, supply, coordination); and (5) space and settlements (urban plans, environmental risks, housing/land, public space). Do No Harm and gender equality serve as cross-cutting themes integrated throughout all five areas. The framework is applied across all phases: framing questions (Step 3), desk review (Tool 2), question guides (Tools 5A–5G), debrief synthesis (Tool 6), and final findings analysis (Tool 7). Based on Campbell (2016) ALNAP typology of urban systems; explicitly systems-thinking in design — aims to understand both individual thematic areas and their inter-relations.

*Limitations:* Qualitative only; designed primarily for displacement crises; assumes sufficient time and access to explore all five themes; may require selective focus under resource constraints.

---

### Urban Displacement Crisis Typology
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TYPOLOGY-001`** | knowledge_layer: conceptual

A four-category classification used to frame the scope and focus of the context analysis, differentiating both the origin and location of crisis:

| Type | Description |
|---|---|
| I | Conflict that causes internal displacement TO a city (IDPs) |
| II | Conflict that causes refugee displacement TO a city |
| III | Violent conflict WITHIN a city (in-situ urban population affected) |
| IV | Naturally triggered hazards WITHIN a city or displacement TO a city |

Applied in Step 2 to determine which populations of interest to prioritise, which sub-areas to select, and which thematic questions are most salient. Types are not mutually exclusive; multiple types may co-occur in the same city.

---

### Urban Context Analysis
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-001`** | knowledge_layer: conceptual

A structured inquiry into the political, economic, social, service delivery, and spatial factors that enable or hinder effective crisis responses in urban settings. Answers "why" questions — why things are the way they are, how they are connected, what influences decision-makers — rather than "what" needs and gaps exist. Enables identification of entry points, stakeholder interests, power dynamics, governance structures, and systemic drivers of vulnerability. Distinct from needs assessment (which identifies gaps), vulnerability assessment (household-level), and macro-level political economy analysis (which is narrower in scope).

*Limitations:* Primarily designed for urban displacement crises; qualitative in nature; requires existing country presence; findings become outdated in dynamic contexts (see RULE-002 on 6–9 month reassessment).

---

### Sub-Area as Unit of Analysis
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-002`** | knowledge_layer: conceptual

A geographically-bounded community within a city used as the primary spatial unit for primary data collection. May be defined by formally designated administrative boundaries (municipality or ward) or by physical landscape features (roads, rivers) combined with social analysis considerations, citing Parker and Maynard (2015). Approximately one to two days of data collection per sub-area is typical. The toolkit operates at two scales: city-wide level (governance, systems, stakeholders) and sub-area level (community dynamics, local service access).

*Limitations:* Sub-area boundaries are socially constructed and may not match administrative boundaries; urban heterogeneity may mean even a single sub-area contains multiple distinct communities.

---

### Context Analysis vs Needs Assessment Distinction
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-003`** | knowledge_layer: conceptual

A fundamental distinction between two complementary but non-substitutable analytical approaches. Context analysis focuses on "why" questions — systemic and structural factors, power dynamics, institutional capacities, and actor incentives. Needs assessment focuses on "what" questions — visible effects, current service gaps, and quantifiable needs. The source states explicitly: "A context analysis is not focused on needs and, therefore, must be understood as quite distinct from a needs assessment." Both are required; context analysis must complement, not replace, needs or vulnerability assessments.

---

### Entry Point Identification
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-CONCEPT-004`** | knowledge_layer: conceptual

The identification of practical and realistic opportunities where external humanitarian actors can engage productively with existing urban systems, actors, and processes to support crisis response. Entry points are grounded in analysis of power relations, stakeholder interests, institutional capacities, and governance structures — they represent what is contextually feasible, not only technically ideal. Positioned as the terminal output purpose of the entire context analysis process. Documented in Tool 8 (Programme implications). Urban entry points are more constrained than rural: more actors, more institutional layers, limited humanitarian leverage.

---

### Do No Harm
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-PRINCIPLE-001`** | knowledge_layer: conceptual | cross-cutting principle

Programmes must not increase tensions or undermine existing local systems — including existing service providers and local government support structures. Integrated as a cross-cutting analytical theme throughout all 10 steps and all 5 thematic areas. Operationalised through: Do No Harm guiding questions in Table 3; protection-sensitive data collection protocols (RULE-005, IMPL-004); programme implications analysis (Tool 8); and partner selection risk assessment (RULE-003). See also decision rule RULE-004 for operational application.

---

### Gender Equality Analytical Lens
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-PRINCIPLE-002`** | knowledge_layer: conceptual | cross-cutting principle

Every step of the context analysis must systematically examine gender disparities — differences between women and men in assigned responsibilities, activities, resource access, service access, and decision-making opportunities. Implemented through: gender-specific guiding questions (Table 3); gender-separated FGDs with same-sex facilitators (RULE-001); gender comparison column in Tool 7 findings analysis; and women-only working groups in validation workshops when contextually needed (RULE-011). Note: if gender equality is the primary focus, a dedicated in-depth gender analysis tool is recommended instead (RULE-009).
...
#### Urban Context Analysis Process (3-Phase, 10-Step Method)
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-001`** | knowledge_layer: diagnostic

A 3-phase, 10-step iterative workflow for conducting urban humanitarian context analysis, designed to be adaptable to varied urban crisis settings. Total elapsed time: typically 4–6 weeks (1–2 weeks preparation, 2 weeks data collection, 1–2 weeks analysis/documentation).

| Phase | Steps |
|---|---|
| Phase 1 — Preparation | Step 1: Launch (workplan, budget, team); Step 2: Frame analysis (scope, sub-areas, crisis type); Step 3: Select initial questions (adapt thematic framework) |
| Phase 2 — Data Collection | Step 4: Collate secondary data (desk review, stakeholder mapping); Step 5: Prepare primary data collection (plan, adapt guides, train team); Step 6: Carry out primary data collection (KIIs, FGDs, daily debriefs, mid-collection review) |
| Phase 3 — Analysis and Documentation | Step 7: Analyse data (key findings, programme implications); Step 8: Validation workshop; Step 9: Write final report; Step 10: Communicate findings |

The process is iterative — desk review shapes stakeholder mapping; early data collection findings refine question guides and sampling; mid-collection review adjusts focus; validation workshop challenges preliminary findings before final documentation.

*field_query_trigger: How do I structure a context analysis in an urban displacement crisis to understand systemic power, service, and governance dynamics before programme design?*

*Limitations:* Not prescriptive for programme design; primarily qualitative; assumes ~2-week in-country data collection baseline and existing country presence; not suitable for immediate response contexts.

---

#### Desk Review Method
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-002`** | knowledge_layer: diagnostic

Secondary data synthesis conducted 2–3 weeks before primary data collection to map existing knowledge, identify gaps, and conceptualise efficient fieldwork. Synthesizes crisis background, demographic data, governance structures, service delivery systems, policies, and prior assessments. Duration: 2 days to 1 week. Led by team lead; in-country staff involvement required. Outputs: completed desk review (Tool 2), initial stakeholder analysis (partial Tool 3), revised thematic guiding questions, input to data collection plan (Tool 4).

*field_query_trigger: How do I conduct a desk review of secondary data to map existing knowledge and identify gaps before primary data collection in an urban humanitarian context analysis?*

---

#### Key Informant Interview (KII) Method
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-003`** | knowledge_layer: diagnostic

Semi-structured interviews with influential stakeholders at city-wide and sub-area levels, informed by prior stakeholder analysis. Sampling uses purposive selection from Tool 3 expanded via snowball/referral (METHOD-008). Uses adapted Tools 5C–5G. Requires: team lead oversight of notetaking quality and probing; daily debriefs and mid-collection review; deliberate inclusion of "difficult stakeholders." KII notes must exclude identifiable information.
...
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-004`** | knowledge_layer: diagnostic

Structured group discussions with displaced and host community populations in selected urban sub-areas, separated by gender and age with same-sex facilitators (RULE-001). Uses adapted Tools 5A–5B. Requires: informed consent; protection risk briefing for all team members including translators; deliberate inclusion of marginalized groups; daily debrief and mid-collection gap review. FGD notes must exclude identifiable information.

*field_query_trigger: How do I facilitate focus group discussions with displaced and host community populations in urban sub-areas while managing protection risks and ensuring gender-disaggregated data?*

---

#### Stakeholder Analysis / Actor Mapping
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-005`** | knowledge_layer: diagnostic

Iterative identification and analysis of influential stakeholders — type, level, role, interests, incentives, influence, and relationships. Updated progressively from desk review (Step 4, initial mapping) through data collection to final analysis (Step 7, full update). Explicit requirement to include "difficult stakeholders" — armed groups, gatekeepers, corrupt officials. Outputs: stakeholder analysis matrix (Tool 3), KII candidate list, coordination/partnership strategy inputs.
...
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-006`** | knowledge_layer: diagnostic

One- to two-facilitator workshop with 15–20 diverse participants (analysis team, consulted stakeholders, internal staff, external local partners) to challenge and refine preliminary findings before final documentation. Inputs: preliminary drafts of Tools 7, 8, and 3. Step is optional under time or resource constraints. Requires: gender diversity of participants; women-only working groups if contextually needed (RULE-011); structured facilitation (Tool 9); confidentiality of data sources maintained.
...
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-007`** | knowledge_layer: diagnostic

Analytical approach that examines interconnections and relations between urban thematic areas rather than analysing each theme in isolation, based on Campbell (2016) ALNAP typology of urban systems. Requires covering all 5 themes; Do No Harm and gender equality applied cross-cuttingly, not separately; team debriefs specifically structured to surface cross-thematic patterns. Outputs: cross-thematic analytical findings, system-level entry points, structural risk drivers.
...
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-METHOD-008`** | knowledge_layer: diagnostic

During KIIs and FGDs, continuously solicit referrals from participants for additional informants, particularly to reach marginalized, displaced, or inaccessible groups. Key mechanism for reaching actors invisible in formal stakeholder analyses. Monitor for over-representation of particular networks; monitor daily for representation gaps in vulnerable groups.
...
The toolkit comprises 10 named instruments. All tools are available at the URLs listed in the document annexes (pp. 38–39).

#### Tool 1 — Urban Context Analysis Workplan and Budget Template
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-001`** | diagnostic

Illustrative workplan and budget template calibrated to a 14-day on-site analysis. Columns for activities, timeline, team time allocation, and budget estimation by line item. Used in Step 1 to plan, sequence, and cost the analysis. Must be adapted to context; does not cover contingency costs for security incidents.

*field_query_trigger: How do I plan and budget a 2–4 week urban humanitarian context analysis for a displacement crisis, including team composition and logistics costs?*

---

#### Tool 2 — Desk Review Summary Template
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-002`** | diagnostic

Template for reviewing secondary data by sub-theme of the thematic framework. Includes optional desk review memo format and guidance on secondary data sources per sub-theme. Must be completed 2–3 weeks before primary data collection. Bridges desk review findings to Tool 3 (stakeholder mapping), revised guiding questions, and Tool 4 (data collection planning).

*field_query_trigger: What secondary data should I collect, document, and analyse before conducting field interviews for an urban humanitarian context analysis in a displacement setting?*

---

#### Tool 3 — Stakeholder Analysis Matrix
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-003`** | diagnostic

Multi-column spreadsheet matrix for listing, categorizing, and analyzing stakeholders. Columns B–E (populated Step 4): stakeholder name/position, type, level, role. Columns F–J (populated Step 7): importance to programme, engagement strategy, actor incentives. Cross-phase tool — used in Steps 4, 5–6, and 7. Must include "difficult stakeholders" explicitly.

*field_query_trigger: How do I map and analyze key stakeholders — government, civil society, private sector, and difficult actors — for a humanitarian programme in an urban displacement context?*

---

#### Tool 4 — Data Collection Plan Template
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-004`** | diagnostic

Two-tab template: Tab 4A for sub-area sampling (FGDs + sub-area KIIs); Tab 4B for city-wide sampling (institutional and governance KIIs). Covers who to interview, with what tools, with what sampling approach, with what logistics. Updated continuously throughout data collection as snowball referrals expand the sample.

*field_query_trigger: How do I plan data collection logistics — who to interview, with what sampling approach — across multiple sub-areas and city-wide for an urban humanitarian context analysis?*

---

#### Tools 5A–5G — KII and FGD Question Guide Set
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-005`** | diagnostic

Set of 7 sample semi-structured guides: Tool 5A (FGD, displaced populations), Tool 5B (FGD, host communities), Tool 5C (KII, influential stakeholders), Tool 5D (KII, service providers), Tool 5E (KII, labour/business climate), Tool 5F (KII, local government), Tool 5G (KII, NGO service providers). All aligned with the 5-theme + Do No Harm + gender framework. Must be adapted for every context (RULE-008): remove irrelevant questions, add context-specific questions, validate with country staff, pilot in target sub-areas. Protection briefing for all team members required before use.
...
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-006`** | diagnostic

Two-sheet template for structured daily and mid-collection team synthesis. Sheet 1 maps preliminary findings per sub-area to the thematic framework; Column G identifies which question guide modules populate each sub-theme. Sheet 2 lists local service providers identified during data collection. Used in Steps 6 and 7; bridges data collection to formal analysis. Mid-collection review requires cleaning notes in Tool 6 and sharing with team.

*field_query_trigger: How do I structure team debriefs and mid-collection reviews to identify data gaps and adjust sampling during an urban context analysis fieldwork phase?*

---

#### Tool 7 — Key Findings Analysis Template
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-007`** | diagnostic

Two-tab template. Tab 7A: organises all context analysis findings by sub-area and theme, with columns for cross-area comparison (Column I), gender comparison (Column J), population comparison (Column K), age comparison (Column L), identified risks (Column M), and programming implications (Column N). Tab 7B (optional): dividers and connectors analysis to further investigate social cohesion factors. Used in Step 7 to consolidate desk review and primary data.

*field_query_trigger: How do I consolidate and analyse urban context analysis findings across sub-areas, themes, gender, and population groups to identify programming entry points?*

---

#### Tool 8 — Programme Implications Template
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-008`** | diagnostic

Five-table template translating key findings and stakeholder analysis into programming action. Tables cover: (1) programming opportunities, geographic priorities, sub-population needs, constraints; (2) potential partners by sector and geography; (3) advocacy issues and partners; (4) risk mitigation strategies; (5) strategies to harness connectors. Used in Step 7; inputs to validation workshop (Step 8). Sourced from columns F–O of Tool 7 and Tool 3.

*field_query_trigger: How do I translate urban context analysis findings into programming opportunities, partnership options, risk mitigation strategies, and advocacy priorities?*

---

#### Tool 9 — Urban Analysis Validation Workshop
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-009`** | diagnostic

One-day urban analysis workshop tool containing: (a) draft workshop agenda for 15–20 diverse participants; (b) participant list template; (c) facilitators' agenda with group activities, session structure, and notetaking arrangements. Input tools: preliminary drafts of Tools 7, 8, and 3. Outputs: refined versions of Tools 7, 8, and 3 plus participant list.

*field_query_trigger: How do I facilitate a one-day stakeholder validation workshop to challenge and refine preliminary urban context analysis findings before finalizing the report?*

---

#### Tool 10 — Urban Context Analysis Final Report Outline
**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-TOOL-010`** | diagnostic

Table of contents and summary methodological tables for an internal context analysis report. Provides structure for synthesizing all analysis outputs into a final document. Assumes internal audience; sensitive and commercially confidential findings should be reviewed before external sharing (RULE-012). Note: a final written report is optional — validation workshop outputs may suffice (ASM-003).

*field_query_trigger: How do I structure an internal urban context analysis report to document findings on governance, social dynamics, services, and programming implications for a displacement setting?*
...
### TNS-001: Assumption of representative sampling vs. structural bias risk

**Tension type:** Methodological

**First position (ASM-002):** The toolkit assumes that adequate diversity of participants — including women, marginalized groups, ethnic minorities, and displaced populations — can be achieved through deliberate sampling design and careful team composition. Guidance across Steps 5–6 and the validation workshop treats representation as an achievable standard if proper steps are followed.

**Conflicting position (RISK-001):** The toolkit simultaneously acknowledges that relying on key powerholders to organize participation is a structural bias risk that deliberate design may not fully overcome. Teams operating under time pressure default to accessible participant channels (community leaders, gatekeepers), which systematically exclude marginalized voices.

**Why it matters:** If the assumption holds, the toolkit's guidance on deliberate sampling constitutes sufficient mitigation and practitioners can follow it with confidence. If RISK-001 dominates, the toolkit overstates its ability to produce representative data in access-constrained urban settings, and practitioners may need to supplement with additional bias-mitigation methods not described in this document. The source does not resolve this tension — it is an honest design limitation.

**Related objects:** ASM-002, RISK-001, METHOD-004, SAFE-002

---

### Internal Contradiction: Primary use case vs. rapid-response adaptability (low confidence)

The document states the toolkit "is generally designed with the assumption of approximately two weeks in country of data collection" and assumes prior country presence (p. 9), while simultaneously noting in footnote 3 that it can be adapted for rapid-response by referencing alternative tools (GECARR, IRC conflict sensitivity toolkit). This creates mild tension between the explicit primary use case (established in-country organisations conducting structured analysis) and the implied adaptability of the approach. RULE-009 partially addresses this by pointing practitioners to alternative tools when the toolkit's full structure is not appropriate.

---

### Assumptions Table

| object_id | assumption | explicit_or_inferred | risk_if_violated |
|---|---|---|---|
| ASM-001 | Toolkit designed for organisations already established in-country for several months; baseline ~2 weeks in-country data collection | explicit | Severely limits applicability for first-entry or rapid-response organisations; methodology may be too resource-intensive |
| ASM-002 | Adequate diversity of participants (including women, marginalized groups, displaced) achievable through deliberate sampling design and team composition | inferred | May not hold in high-insecurity contexts; creates overconfidence in analysis representativeness; see TNS-001 |
| ASM-003 | Final written report is optional — validation workshop outputs may suffice to complete the context analysis | explicit | Institutional knowledge not captured in durable transferable format; future staff or partners cannot access findings; premature analytical closure |

---

### Dependencies Table

| dependency | required by | consequence of failure |
|---|---|---|
| Existing country presence and access | METHOD-001, ASM-001 | Full toolkit not usable; must use rapid-response alternatives (GECARR, IRC conflict sensitivity toolkit) |
| Qualified team lead with qualitative research experience | IMPL-001 | Low-quality analytical framing; insufficient question probing; weak analysis |
| National staff with local language and community access | IMPL-001, RULE-013 | KII/FGD quality degraded; identity-masking risk unmitigated (RISK-002); sampling bias heightened (RISK-001) |
| Desk review completed 2–3 weeks before fieldwork | RULE-007, METHOD-002 | Data collection wastes time on already-documented information; question guides not optimally adapted |
| Question guides adapted before fieldwork | RULE-008, IMPL-007 | Irrelevant questions collected; critical context-specific dynamics missed |
| Informed consent and protection protocols in place | RULE-005, SAFE-001 | Participant harm; organizational reputational and legal exposure |
...
All decision rules extracted from this source. Rules are grouped thematically.

---

### Partner and Team Composition

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-003`** — Restrict or exclude new local partners when significant conflict or protection dynamics are present

- **Condition:** When considering including new local or international partners in context analysis execution, and a significant conflict or protection dynamic is active.
- **Action:** Assess three factors before inclusion: (1) protection concerns for partner staff in data collection; (2) risks of bias from partner that cannot be mitigated through team composition; (3) risks to participants from public sharing of findings. Exercise caution — do not include by default.
- **Exception:** Partners with established conflict-sensitivity protocols, strong data protection practices, and pre-existing trusted community relationships may be included with documented safeguards.
- **Cross-references:** IMPL-003 (joint analysis design), RISK-003 (partner bias risk), TOOL-003
- **⚠ human_review_required:** The source does not define criteria for what constitutes a "significant" conflict or protection dynamic — requires contextual judgment.

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-013`** — Recruit facilitators and interviewers from the same social groups as target participants

- **Condition:** When composing the data collection team for any analysis involving specific displaced or minority population groups.
- **Action:** Recruit interviewers and facilitators from the same country, city, or social group as participants (same refugee community, same ethnic minority, same gender). Use counterparts trained in question nuances rather than generic translators. Where same-group recruitment is not possible, document the gap and take mitigating steps.
- **Rationale:** Source states this as "essential" — strongest normative language used for any team composition guidance. Ties to LESSON-002 (Dar es Salaam identity masking case).
- **Cross-references:** IMPL-001 (team composition), METHOD-003 (KII), METHOD-004 (FGD), RULE-001, SAFE-002

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-010`** — Conduct participatory planning workshop when in partnership or when staff have limited local knowledge

- **Condition:** When analysis is conducted in formal partnership with another organisation, OR when team staff have limited knowledge of local communities in target areas.
- **Action:** Conduct an optional participatory data collection planning workshop (half-day to one-day) with locally-knowledgeable stakeholders before fieldwork begins. Use Optional Tool: City overview workshop.
- **Exception:** Not required when the team has strong existing local knowledge and is not in formal partnership.
- **Cross-references:** TOOL-004, METHOD-006, RULE-003

---

### Data Collection Design

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-001`** — Separate FGDs by gender and age with same-sex facilitators

- **Condition:** When planning FGDs in urban humanitarian context analysis, particularly when adolescents are included or gender/protection sensitivities are present.
- **Action:** Plan separate FGDs for men and women / adolescent boys and girls; assign same-sex facilitators to each group.
- **Rationale:** "Adolescents in particular may be less likely to speak in a mixed-gender group" (p. 25); essential for capturing women's and girls' experience of barriers to service access.
- **Cross-references:** METHOD-004, TOOL-005, PRINCIPLE-002, RULE-011 (extends to validation workshop)

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-007`** — Complete desk review 2–3 weeks before primary data collection

- **Condition:** When planning the timeline for urban context analysis, prior to initiating KIIs and FGDs.
- **Action:** Complete desk review 2–3 weeks before primary data collection begins; use the window to revise the data collection plan (Step 5) based on gaps identified.
- **Exception:** In rapid response contexts, timeline may be compressed, but desk review must still precede fieldwork.
- **Cross-references:** METHOD-002, TOOL-002, TOOL-004

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-008`** — Adapt question guides to each context — never use default templates without adaptation

- **Condition:** When preparing KII and FGD question guides for any new urban context analysis.
- **Action:** (1) Eliminate irrelevant questions or those already answered by desk review; (2) add context-specific questions; (3) validate with country staff; (4) brief the team on protection risks around sensitive questions (GBV, child exploitation). Note: questions on legal protection are less relevant for IDP contexts than refugee contexts.
- **Rationale:** "Just as no context is the same, no context analysis will be the same" (p. 25) — un-adapted guides risk collecting irrelevant data and missing critical local dynamics.
- **Cross-references:** TOOL-005, FRAMEWORK-001, IMPL-007

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-009`** — Use a dedicated gender analysis tool when gender equality is the sole analytical interest

- **Condition:** When the organisation's analytical interest is limited to gender equality as the primary or sole focus.
- **Action:** Conduct an in-depth gender analysis (e.g. IRC Gender Analysis and Program Design Toolkit) instead of this toolkit. The toolkit's gender lens is cross-cutting, not a substitute for dedicated gender analysis.
- **Exception:** When gender is one of multiple analytical interests — in that case, the toolkit's cross-cutting gender theme is appropriate.
- **Cross-references:** PRINCIPLE-002, FRAMEWORK-001

---

### Protection and Data Security

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-004`** — Apply Do No Harm throughout all data collection and analysis activities

- **Condition:** Applies at all stages — questionnaire design, sampling, data collection, analysis, and findings communication.
- **Action:** Apply Do No Harm lens at each stage: tailor questionnaires to avoid exacerbating tensions; apply geographic and social sensitivity in sampling; ensure findings communication does not expose participants to harm; assess how programmes might inadvertently increase tensions or undermine local systems.
- **Cross-references:** PRINCIPLE-001, FRAMEWORK-001, TOOL-005, RULE-005, RULE-012

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-005`** — Protect participant data — anonymize, limit access, destroy raw notes after analysis

- **Condition:** After primary data collection is complete and debrief notes have been consolidated.
- **Action:** Store interview notes securely with access limited to few persons; notes must not include identifiable information (names, specific locations); destroy raw notes after analysis completes unless retention is specifically planned and resourced (with full transcription and anonymization).
- **Cross-references:** TOOL-006, TOOL-005, SAFE-001, RISK-002

---

### Analysis and Validation

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-006`** — Triangulate findings from multiple sources before concluding analysis

- **Condition:** During Step 7 data analysis and interpretation.
- **Action:** Triangulate information across multiple sources, methods (desk review + KII + FGD), and team perspectives; ensure team members and key stakeholders have opportunity to challenge findings before conclusions are drawn.
- **Cross-references:** METHOD-006, TOOL-007, IMPL-005

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-011`** — Designate women-only working groups in validation workshop when women face obstacles to mixed participation

- **Condition:** When women face obstacles to participating in mixed group discussions during the validation workshop.
- **Action:** Designate women-only working groups with documented products; ensure facilitators include these contributions in synthesis; use targeted invitations rather than blanket organisational invitations to ensure gender diversity.
- **Cross-references:** TOOL-009, METHOD-006, RULE-001, PRINCIPLE-002

---

### Communication and Reporting

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-012`** — Produce internal-only report when findings contain sensitive or confidential information

- **Condition:** When context analysis findings contain sensitive contextual, political, or protection information, or commercially confidential content; assessed before beginning the write-up process.
- **Action:** Produce internal-only report (Tool 10 assumes this by default); clarify before writing whether an external summary is also needed; when sharing externally, anonymize all sources and respect informed consent commitments.
- **Exception:** If analysis did not involve sensitive dynamics, a non-sensitive external brief may be produced alongside the internal report (Maiduguri case lesson, LESSON-003).
- **Cross-references:** TOOL-010, IMPL-006, RULE-005, LESSON-003

---

### Context Analysis Currency

**`S-2017-iied-urban-context-analysis-toolkit-guidance-note-RULE-002`** — Reassess context analysis after 6–9 months or significant context change

- **Condition:** When any of these triggers apply: (a) findings are more than 6–9 months old before use for programming; (b) significant crisis change occurred (policy change, major incident, resolution); (c) new data collection is planned; (d) new proposal requires deeper context information.
- **Action:** Revise or redo the context analysis; partial update is acceptable when changes are limited to specific themes or sub-themes.
- **Limitations:** The 6–9 month threshold is a practitioner heuristic, not an evidence-based figure; highly volatile contexts may require more frequent updates.
- **Cross-references:** METHOD-001, TOOL-010, RISK-004
...
The following findings require human review before integration into target wiki pages.

| finding_id | object_id | label | trigger reason | recommended action |
|---|---|---|---|---|
| F-029 | RULE-003 | Partner Inclusion Restriction Rule | Rule requires contextual judgment the source does not fully specify — "significant conflict or protection dynamic" is not defined with criteria. Downstream advisory use risks over- or under-restriction without a defined threshold. | Human reviewer to add criteria or flag as judgment-dependent before creating the decision protocol page. Consider adding a decision aid (severity matrix) as a supplement. |
| F-059 | TNS-001 | Sampling Representativeness Tension | Unresolved methodological tension between ASM-002 (representative sampling achievable by design) and RISK-001 (powerholder dependence bias may not be overcome by design). Source does not resolve this — it is an acknowledged design limitation. | Human reviewer to decide: (a) whether to flag the known-tensions page as open/unresolved; (b) whether to commission supplementary guidance for high-insecurity contexts; (c) whether to downgrade ASM-002 confidence in downstream advisory use. |

**Additional task seed check (SEED-002 and SEED-007):**
Both SEED-002 and SEED-007 are priority: high with coverage: partial. Neither involves a missing decision rule. No additional Gate A items triggered by task seed review.

**Conflict log reference:** See `scratch/S-2017-iied-urban-context-analysis-toolkit-guidance-note/writer-conflicts.yaml`
- One ID conflict: TNS-001 defined in C-W5 but absent from id-registry.yaml — registry update required.
- No dangling references to undefined objects (TNS-001 body is fully defined in C-W5).
- No duplicate IDs detected across workers.
