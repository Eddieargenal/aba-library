...
## Stage purpose
Determine the most appropriate response modalities for each sector and population group. Assesses market functionality, local capacity, and outcome probability to select the optimal combination of cash, in-kind, direct works, referral, advocacy, and technical assistance.

## Key decisions
TODO[agent]: Define 3-5 key decisions that must be made at this stage. Key sources: 2017_mohiddin-smith-phelps_urban-response-analysis-framework, 2019_alnap_global-practice-review-urban-humanitarian-response.

## Required evidence
TODO[agent]: Define minimum evidence required before this stage can be completed.

## Tools to use
- [[../04-tools/09-response-option-comparison-tool]]
...
## Links
- Related framework: [[../03-frameworks/urban-drr-response-design-framework]]
