...
key_tools:
  ...
  - tool-14-accountability-feedback
  - tool-15-referral-pathway
source_foundation:
...
# Stage 8: Area-Based Implementation

## Stage purpose
Implement the area strategy through coordinated multi-sector programming, active coordination platform management, real-time gap/duplication tracking, referral pathway management, and community accountability mechanisms.

## Key decisions
TODO[agent]: Define 3-5 key decisions that must be made at this stage. Key sources: 2019_alnap_global-practice-review-urban-humanitarian-response, 2017_sanderson-sitko_urban-area-based-approaches-post-disaster-guide.

## Required evidence
TODO[agent]: Define minimum evidence required before this stage can be completed.

## Tools to use
- [[../04-tools/12-implementation-sequencing-tool]]
- [[../04-tools/13-area-coordination-dashboard]]
- [[../04-tools/14-accountability-feedback-tool]]
- [[../04-tools/15-referral-pathway-tool]]
...
## Links
- Related framework: [[../03-frameworks/area-based-coordination-framework]]
