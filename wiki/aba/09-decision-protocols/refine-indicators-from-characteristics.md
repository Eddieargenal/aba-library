...
trigger_conditions:
- project already has donor-agreed indicators
- qualitative resilience framework must be reconciled with quantitative reporting
escalation_path: M&E lead; donor focal point if indicator change requires contract
  amendment
sections:
- id: trigger
  anchor: "#trigger"
