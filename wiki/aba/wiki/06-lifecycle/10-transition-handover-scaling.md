...
## Key decisions
TODO[agent]: Define 3-5 key decisions that must be made at this stage. Key sources: 2017-sanderson-sitko-urban-area-based-approaches-post-disaster-guide, 2015-undrr-sendai-framework-drr-2015-2030-framework.

## Required evidence
TODO[agent]: Define minimum evidence required before this stage can be completed.

## Tools to use
- [[./04tools/17-handover-scale-up-tool]]
...
## Links
- Related framework: [[./03frameworks/transition-handover-framework]]
