...
| --------------------------- | ----------------------------------------------------- | ---------------------------------------------------- | ----------------------------------------------------- |
| [[ingest.md]]               | New source document to add to ABA knowledge base      | Raw PDF saved, raw-content mirror updated, extracted source page updated, synthesis pages updated, index rebuilt | Start here for any new source document                |
...
| [[document-extraction.md]]  | PDF, image, spreadsheet, or document to extract       | Structured markdown output, including ABA raw-content extraction targets | Exact reproduction only — no interpretation           |
