...
|---|---|---|---|
| [[frontmatter-schema]] | Required YAML frontmatter fields for every page type (source, tool, field-instrument, concept) | Before creating or validating any wiki page | When you only need to read existing pages |
...
| [[ingest-rules]] | 15-step ingest sequence; source status values (not-started → reviewed) | Before ingesting a new source document | During query or lint operations |
...
| [[page-types]] | Definitions for all 12 wiki page types with folder locations and frontmatter | When creating a new page type or verifying page classification | For operational queries |
