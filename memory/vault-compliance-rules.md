---
name: vault-compliance-rules
description: The 10 non-negotiable rules for vault content — source citation, claim taxonomy, review status, and append-only logging.
version: 1.0.0
